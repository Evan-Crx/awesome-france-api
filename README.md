...
Contributions bienvenues ! Les règles :

1. **API utile aux développeurs en France** (officielle, gouvernementale, ou produit SaaS FR largement adopté).
2. **Plan gratuit disponible ou au moins free tier honnête** (500 req/mois minimum, pas juste un trial).
3. **Documentation publique** accessible sans contrat.
4. **Format** : `- [Nom](URL) — Description courte (max ~200 caractères) mentionnant ce qui rend l'API utile.`
5. **Catégorie** alphabétique dans sa section.
6. **1 API par PR**, titre `Add <Name>` ou `Update <Name>`.

Ouvre une PR directement ou une issue si tu n'es pas sûr de la catégorie.

## License

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

Cette liste est dans le domaine public (CC0 1.0). Copie, redistribution et modification libres.
